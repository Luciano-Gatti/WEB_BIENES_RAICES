...
<div class="contenedor seccion seccion-inferior">
        ...
        <article class="entrada-blog">
            ...
            <div class="texto-entrada">
                <a href="entrada">
                    ...
                    <p class="informacion-meta">Escrito el: <span>10/01/2024</span> por: <span>Admin</span></p>
    ...
    <section class="testimoniales">
        ...
        <div class="testimonial">
            <blockquote>
                El personla se comportó de una excelente forma, muy buena atención 
                y la casa que me ofrecieron cumple con todas mis expectativas.
            </blockquote>
            <p>- Luciano Gatti</p>
        </div>
    </section>
</div> <!--contenedor blog y testimoniales-->